...
class Product extends \Magento\Rule\Model\Condition\AbstractCondition
{
    ...
    public function collectValidatedAttributes($productCollection)
    {
        ...
        if (!in_array($attribute, ['category_ids', 'qty', 'php', 'is_in_stock', 'manage_stock', 'status_parent', 'is_salable'])) {
    ...
    public function validate(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        switch ($attrCode) {
            ...
            case 'category_ids':
                $catIds = $object->getAvailableInCategories() + $object->getCategoryIds();
            ...
            case 'qty':
                if ($object->getTypeId() == 'configurable') {
                    ...
                    $childs = $this->productCollectionFactory->create()
                        ->addFieldToFilter('entity_id', ['in' => $childs[0]])
                        ->joinField(
                            'qty',
